...
[b, a] = scipy.signal.butter(order, critical_freq, btype='low', analog=False, output='ba', fs=sampling_freq)

print("Butterworth filter order: " + str(order) + ", critical frequency: " + str(critical_freq) + " Hz, sampling frequency: " + str(sampling_freq) + " Hz, parameters: ")
